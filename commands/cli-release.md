---
description: "Prepare a new release of the Nayan CLI"
argument-hint: "[version-description]"
---

**Single-repo:** This command targets the Nayan extension monorepo. **Multi-repo:** Not applicable — CLI lives in a single repo. If used in a Decoupled Fullstack multi-repo workspace, skip or inform user.
