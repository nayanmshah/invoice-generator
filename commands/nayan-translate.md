---
description: "Translate and localize strings in the Nayan extension"
argument-hint: "[language-code or 'all'] [string-key or file-path]"
---

Perform translation and localization tasks for the Nayan extension. For full product development pipeline (greenfield/brownfield), use Orchestrator mode instead. This command activates the translation workflow with comprehensive i18n guidelines.
...
- `/nayan-translate de` - Focus on German translations
- `/nayan-translate all welcome.title` - Translate a specific key to all languages
- `/nayan-translate zh-CN src/i18n/locales/zh-CN/core.json` - Work on specific file
